...
| [#198](../../issues/198) | No accessibility floor on modals                                       | 🟡 Open by design — wave 1 (PR #285) merged, wave 2 (#284, PR #298) open awaiting review; 2 items (`TransitionPanel`, access-denied overlay) deferred as separate manual-judgment calls |
| [#192](../../issues/192) | No backup / disaster-recovery runbook                                  | 🟡 Open by design — PR #286 merged (backup script + tested restore runbook); issue stays open for a maintainer RPO/RTO + cron-schedule decision, per the PR's own scope note            |
| [#194](../../issues/194) | `tests/e2e/` has no actual test harness                                | ✅ Closed — PR #287 merged, satisfies the issue's own bar ("even one real passing e2e spec"); broader endpoint coverage available as an unscoped follow-on                              |
