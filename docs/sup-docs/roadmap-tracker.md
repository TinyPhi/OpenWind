...
| 2D    | No-code builders + reporting               | [#15](../../issues/15)                        | PrabhuVijit | ✅ Done | 100 | Automation wizard, saved views, export (sync + async BullMQ), workflow visual editor. Metabase embed deferred to Phase 3.                                                                                         |
