...
| ~~#433~~                 | ~~docs(adr): write ADR for plugin system (3B) design decisions~~                   | abmish         | 2026-08-19 | 3B / ADR                 | ✅ Closed 2026-08-25 — Accepted as `docs/decisions/ADR-011-plugin-system.md`                                                                                                   |
