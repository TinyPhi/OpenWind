...
| T39  | Prometheus metrics: register `openwind_oncall_*` + `openwind_notification_*` + `openwind_label_*` in `packages/telemetry/src/metrics.ts`                                                                                         | 3     | done (oncall*\* only — `openwind_oncall_resolutions_total` counter + `openwind_oncall_coverage_gap_teams` gauge; notification*_/label\__ land with PR 8/labels work)                                                                                                                                                                                                                                                                                                                                                     | T12,T27  |
