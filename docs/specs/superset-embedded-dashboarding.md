...
**T4** (loopback bind, mandatory admin password, SQL Lab off) and **T6** (profile + default) close
...
◻ **not satisfied today** — `apps/api/src/routes/reporting/dashboard-ids.ts` carries four literal
...
| T6  | `profiles: [reporting]` on the `superset` / `superset-init` services **plus `COMPOSE_PROFILES=reporting` in `.env.example`**, so a fresh clone starts reporting and switching it off is one variable rather than a compose edit (R16, amended 2026-09-11); digest-pin the images **and record a re-pin/CVE-check cadence**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | TBD                                                  |
