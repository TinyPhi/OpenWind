...
| task                                                                                                                                                                                                                                                                                                                                                                       | requirement | status |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------ |
| T8: Key Management screen — list (app name, created-by, created-at, expiry, scope preset/summary, status) + create form (all Phase 1 required fields, Read-only/Read-write one-click presets mapping to `scopes` plus a custom-scope picker) + Revoke/Rotate/Emergency-Rotate row actions + amber (≤30d) / red (past) expiry states computed client-side from `expires_at` | R10         | todo   |
