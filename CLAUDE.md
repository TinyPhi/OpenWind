...
| 3F    | Temporal scheduler — auto-create tickets on schedule                                       | 🔴 Spec + design complete 2026-09-07 (`docs/temporal-scheduler-spec`). ADR-017 draft pending human acceptance. 4 phases, 17 tasks. Migrations start at 0104 (0092–0103 consumed by 3E phases 1–2 and PR #586 notification policies/schedule rules). Phase 1 starts after ADR accepted + GH issues opened.                                                                               |
